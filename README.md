...
* [**`PLAN_PILOTO_AGENTES_IA_BUROCRACIA_ADMINISTRATIVA.md`**](./PLAN_PILOTO_AGENTES_IA_BUROCRACIA_ADMINISTRATIVA.md): Piloto de Agentes de IA (Claude Agent SDK) para automatizar la burocracia administrativa entre sistemas (SIGGES/SIGTE/RNLE/RCE), con marco normativo vigente (Ley 21.719, Ley 21.668, Ley 21.663, Ley 21.180) y KPIs de impacto operativo.
